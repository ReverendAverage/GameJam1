...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E InjectMainPS /Fc TranslucentLightInjectionShaders.d3dasm /Fo TranslucentLightInjectionShaders.dxil TranslucentLightInjectionShaders.usf
:END
PAUSE
