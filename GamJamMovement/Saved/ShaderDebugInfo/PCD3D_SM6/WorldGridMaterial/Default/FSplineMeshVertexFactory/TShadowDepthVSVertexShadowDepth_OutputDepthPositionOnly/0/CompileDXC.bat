...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E PositionOnlyMain /Fc ShadowDepthVertexShader.d3dasm /Fo ShadowDepthVertexShader.dxil ShadowDepthVertexShader.usf
:END
PAUSE
