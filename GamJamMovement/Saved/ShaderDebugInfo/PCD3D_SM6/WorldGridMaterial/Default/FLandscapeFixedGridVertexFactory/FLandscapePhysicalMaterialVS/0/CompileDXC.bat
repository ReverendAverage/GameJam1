...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VSMain /Fc LandscapePhysicalMaterial.d3dasm /Fo LandscapePhysicalMaterial.dxil LandscapePhysicalMaterial.usf
:END
PAUSE
