...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VSMain /Fc LandscapeGrassWeight.d3dasm /Fo LandscapeGrassWeight.dxil LandscapeGrassWeight.usf
:END
PAUSE
