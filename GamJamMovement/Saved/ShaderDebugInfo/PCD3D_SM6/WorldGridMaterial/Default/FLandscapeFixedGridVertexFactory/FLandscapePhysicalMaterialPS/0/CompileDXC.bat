...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E PSMain /Fc LandscapePhysicalMaterial.d3dasm /Fo LandscapePhysicalMaterial.dxil LandscapePhysicalMaterial.usf
:END
PAUSE
