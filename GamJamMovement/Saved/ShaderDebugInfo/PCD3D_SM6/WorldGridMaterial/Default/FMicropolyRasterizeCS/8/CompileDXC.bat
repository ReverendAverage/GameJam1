...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MicropolyRasterize /Fc NaniteRasterizer.d3dasm /Fo NaniteRasterizer.dxil NaniteRasterizer.usf
:END
PAUSE
