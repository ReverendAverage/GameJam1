...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E HWRasterizePS /Fc NaniteRasterizer.d3dasm /Fo NaniteRasterizer.dxil NaniteRasterizer.usf
:END
PAUSE
