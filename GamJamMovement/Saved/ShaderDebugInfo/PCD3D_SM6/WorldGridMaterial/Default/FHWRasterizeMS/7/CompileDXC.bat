...
%DXC% /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ms_6_6 /E HWRasterizeMS /Fc NaniteRasterizer.d3dasm /Fo NaniteRasterizer.dxil NaniteRasterizer.usf
:END
PAUSE
