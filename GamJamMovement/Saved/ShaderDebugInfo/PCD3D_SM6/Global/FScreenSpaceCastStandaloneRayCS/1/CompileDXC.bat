...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc SSRTDiffuseIndirect.d3dasm /Fo SSRTDiffuseIndirect.dxil SSRTDiffuseIndirect.usf
:END
PAUSE
