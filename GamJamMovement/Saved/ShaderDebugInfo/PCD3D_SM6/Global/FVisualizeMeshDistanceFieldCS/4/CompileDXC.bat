...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E VisualizeMeshDistanceFieldCS /Fc DistanceFieldVisualization.d3dasm /Fo DistanceFieldVisualization.dxil DistanceFieldVisualization.usf
:END
PAUSE
