...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc SSRTPrevFrameReduction.d3dasm /Fo SSRTPrevFrameReduction.dxil SSRTPrevFrameReduction.usf
:END
PAUSE
