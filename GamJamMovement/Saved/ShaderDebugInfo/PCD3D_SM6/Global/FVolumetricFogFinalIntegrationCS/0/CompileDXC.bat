...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E FinalIntegrationCS /Fc VolumetricFog.d3dasm /Fo VolumetricFog.dxil VolumetricFog.usf
:END
PAUSE
