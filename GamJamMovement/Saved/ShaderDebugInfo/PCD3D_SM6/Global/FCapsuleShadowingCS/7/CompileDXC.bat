...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O1 -Wno-parentheses-equality /T cs_6_6 /E CapsuleShadowingCS /Fc CapsuleShadowShaders.d3dasm /Fo CapsuleShadowShaders.dxil CapsuleShadowShaders.usf
:END
PAUSE
