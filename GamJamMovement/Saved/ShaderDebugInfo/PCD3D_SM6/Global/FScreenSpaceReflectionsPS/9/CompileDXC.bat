...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ScreenSpaceReflectionsPS /Fc SSRTReflections.d3dasm /Fo SSRTReflections.dxil SSRTReflections.usf
:END
PAUSE
