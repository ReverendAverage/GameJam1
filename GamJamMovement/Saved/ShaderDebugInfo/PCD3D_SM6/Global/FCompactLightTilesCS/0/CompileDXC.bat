...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CompactLightTilesCS /Fc LumenSceneDirectLightingCulling.d3dasm /Fo LumenSceneDirectLightingCulling.dxil LumenSceneDirectLightingCulling.usf
:END
PAUSE
