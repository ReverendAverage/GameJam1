...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E DepthExport /Fc NaniteDepthExport.d3dasm /Fo NaniteDepthExport.dxil NaniteDepthExport.usf
:END
PAUSE
