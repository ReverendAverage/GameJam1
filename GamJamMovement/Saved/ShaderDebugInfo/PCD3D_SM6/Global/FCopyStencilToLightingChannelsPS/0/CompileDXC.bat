...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CopyStencilToLightingChannelsPS /Fc DownsampleDepthPixelShader.d3dasm /Fo DownsampleDepthPixelShader.dxil DownsampleDepthPixelShader.usf
:END
PAUSE
