...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E WriteToBoundingSphereVS /Fc VolumetricFog.d3dasm /Fo VolumetricFog.dxil VolumetricFog.usf
:END
PAUSE
