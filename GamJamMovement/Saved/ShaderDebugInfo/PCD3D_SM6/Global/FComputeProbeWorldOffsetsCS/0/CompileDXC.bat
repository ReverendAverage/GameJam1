...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ComputeProbeWorldOffsetsCS /Fc LumenRadianceCache.d3dasm /Fo LumenRadianceCache.dxil LumenRadianceCache.usf
:END
PAUSE
