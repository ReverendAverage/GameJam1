...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E WaterTileCatergorisationCS /Fc SingleLayerWaterComposite.d3dasm /Fo SingleLayerWaterComposite.dxil SingleLayerWaterComposite.usf
:END
PAUSE
