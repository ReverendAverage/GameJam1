...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E InitPageFreeListCS /Fc GlobalDistanceField.d3dasm /Fo GlobalDistanceField.dxil GlobalDistanceField.usf
:END
PAUSE
