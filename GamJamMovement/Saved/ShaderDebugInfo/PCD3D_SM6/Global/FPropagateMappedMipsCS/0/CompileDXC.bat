...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E PropagateMappedMips /Fc VirtualShadowMapPageManagement.d3dasm /Fo VirtualShadowMapPageManagement.dxil VirtualShadowMapPageManagement.usf
:END
PAUSE
