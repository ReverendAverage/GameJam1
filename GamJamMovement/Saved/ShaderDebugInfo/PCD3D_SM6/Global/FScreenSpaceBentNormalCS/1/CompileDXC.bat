...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ScreenSpaceBentNormalCS /Fc LumenScreenSpaceBentNormal.d3dasm /Fo LumenScreenSpaceBentNormal.dxil LumenScreenSpaceBentNormal.usf
:END
PAUSE
