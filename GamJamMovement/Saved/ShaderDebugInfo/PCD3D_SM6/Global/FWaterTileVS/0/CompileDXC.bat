...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E WaterTileVS /Fc SingleLayerWaterComposite.d3dasm /Fo SingleLayerWaterComposite.dxil SingleLayerWaterComposite.usf
:END
PAUSE
