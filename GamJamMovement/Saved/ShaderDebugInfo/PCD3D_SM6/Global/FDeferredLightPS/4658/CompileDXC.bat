...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E DeferredLightPixelMain /Fc DeferredLightPixelShaders.d3dasm /Fo DeferredLightPixelShaders.dxil DeferredLightPixelShaders.usf
:END
PAUSE
