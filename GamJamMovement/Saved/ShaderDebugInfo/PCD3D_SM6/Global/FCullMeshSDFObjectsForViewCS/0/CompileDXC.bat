...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CullMeshSDFObjectsForViewCS /Fc LumenMeshSDFCulling.d3dasm /Fo LumenMeshSDFCulling.dxil LumenMeshSDFCulling.usf
:END
PAUSE
