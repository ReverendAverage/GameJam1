...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc SSDTemporalAccumulation.d3dasm /Fo SSDTemporalAccumulation.dxil SSDTemporalAccumulation.usf
:END
PAUSE
