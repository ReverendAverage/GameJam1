...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPS /Fc PostProcessGBufferHints.d3dasm /Fo PostProcessGBufferHints.dxil PostProcessGBufferHints.usf
:END
PAUSE
