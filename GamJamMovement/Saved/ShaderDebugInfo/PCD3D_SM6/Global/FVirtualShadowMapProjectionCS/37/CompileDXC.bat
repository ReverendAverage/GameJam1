...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E VirtualShadowMapProjection /Fc VirtualShadowMapProjection.d3dasm /Fo VirtualShadowMapProjection.dxil VirtualShadowMapProjection.usf
:END
PAUSE
