...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E SubsurfaceViewportCopyPS /Fc PostProcessSubsurface.d3dasm /Fo PostProcessSubsurface.dxil PostProcessSubsurface.usf
:END
PAUSE
