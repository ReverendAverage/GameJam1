...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E VisualizeVolumetricLightmapPS /Fc VisualizeVolumetricLightmap.d3dasm /Fo VisualizeVolumetricLightmap.dxil VisualizeVolumetricLightmap.usf
:END
PAUSE
