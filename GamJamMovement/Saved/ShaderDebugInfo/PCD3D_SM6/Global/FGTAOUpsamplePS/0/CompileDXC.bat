...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E GTAOUpsamplePS /Fc PostProcessAmbientOcclusion.d3dasm /Fo PostProcessAmbientOcclusion.dxil PostProcessAmbientOcclusion.usf
:END
PAUSE
