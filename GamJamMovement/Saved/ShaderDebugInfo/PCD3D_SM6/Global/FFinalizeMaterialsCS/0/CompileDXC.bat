...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E FinalizeMaterials /Fc NaniteMaterialCulling.d3dasm /Fo NaniteMaterialCulling.dxil NaniteMaterialCulling.usf
:END
PAUSE
