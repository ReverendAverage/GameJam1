...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainOnePassPointLightPS /Fc ShadowProjectionPixelShader.d3dasm /Fo ShadowProjectionPixelShader.dxil ShadowProjectionPixelShader.usf
:END
PAUSE
