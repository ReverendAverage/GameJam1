...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ScreenProbeDownsampleDepthUniformCS /Fc LumenScreenProbeGather.d3dasm /Fo LumenScreenProbeGather.dxil LumenScreenProbeGather.usf
:END
PAUSE
