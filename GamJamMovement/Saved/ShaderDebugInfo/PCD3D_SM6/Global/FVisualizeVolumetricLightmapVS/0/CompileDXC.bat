...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E VisualizeVolumetricLightmapVS /Fc VisualizeVolumetricLightmap.d3dasm /Fo VisualizeVolumetricLightmap.dxil VisualizeVolumetricLightmap.usf
:END
PAUSE
