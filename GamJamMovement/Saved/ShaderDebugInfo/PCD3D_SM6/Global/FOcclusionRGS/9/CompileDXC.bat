...
%DXC% -HV 2021 /auto-binding-space 1 /exports OcclusionRGS /Zpr /O3 /enable-16bit-types -Wno-parentheses-equality /T lib_6_6 /Fc RayTracingOcclusionRGS.d3dasm /Fo RayTracingOcclusionRGS.dxil RayTracingOcclusionRGS.usf
:END
PAUSE
