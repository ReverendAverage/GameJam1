...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CullObjectsForShadowCS /Fc DistanceFieldShadowing.d3dasm /Fo DistanceFieldShadowing.dxil DistanceFieldShadowing.usf
:END
PAUSE
