...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ScreenProbeTraceMeshSDFsCS /Fc LumenScreenProbeTracing.d3dasm /Fo LumenScreenProbeTracing.dxil LumenScreenProbeTracing.usf
:END
PAUSE
