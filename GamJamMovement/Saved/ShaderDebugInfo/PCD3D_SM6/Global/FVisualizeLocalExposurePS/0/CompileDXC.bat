...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPS /Fc PostProcessVisualizeLocalExposure.d3dasm /Fo PostProcessVisualizeLocalExposure.dxil PostProcessVisualizeLocalExposure.usf
:END
PAUSE
