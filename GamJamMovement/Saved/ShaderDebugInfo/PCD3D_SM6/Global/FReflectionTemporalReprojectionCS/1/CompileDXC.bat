...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ReflectionTemporalReprojectionCS /Fc LumenReflections.d3dasm /Fo LumenReflections.dxil LumenReflections.usf
:END
PAUSE
