...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MarkRadianceProbesUsedByGBufferCS /Fc LumenIrradianceFieldGather.d3dasm /Fo LumenIrradianceFieldGather.dxil LumenIrradianceFieldGather.usf
:END
PAUSE
