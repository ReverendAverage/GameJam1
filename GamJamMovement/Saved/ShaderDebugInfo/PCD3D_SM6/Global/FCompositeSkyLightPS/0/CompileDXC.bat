...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CompositeSkyLightPS /Fc CompositeSkyLightPS.d3dasm /Fo CompositeSkyLightPS.dxil CompositeSkyLightPS.usf
:END
PAUSE
