...
%DXC% -HV 2021 /auto-binding-space 1 /exports PathTracingMainRG /Zpr /WX /O3 /enable-16bit-types -Wno-parentheses-equality /T lib_6_6 /Fc PathTracing.d3dasm /Fo PathTracing.dxil PathTracing.usf
:END
PAUSE
