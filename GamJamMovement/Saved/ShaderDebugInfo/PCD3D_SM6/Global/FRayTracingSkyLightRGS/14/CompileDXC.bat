...
%DXC% -HV 2021 /auto-binding-space 1 /exports SkyLightRGS /Zpr /O3 /enable-16bit-types -Wno-parentheses-equality /T lib_6_6 /Fc RaytracingSkylightRGS.d3dasm /Fo RaytracingSkylightRGS.dxil RaytracingSkylightRGS.usf
:END
PAUSE
