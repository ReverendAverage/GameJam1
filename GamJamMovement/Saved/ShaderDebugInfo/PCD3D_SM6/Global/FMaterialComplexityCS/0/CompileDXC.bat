...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E CalculateMaterialComplexity /Fc NaniteMaterialComplexity.d3dasm /Fo NaniteMaterialComplexity.dxil NaniteMaterialComplexity.usf
:END
PAUSE
