...
%DXC% -HV 2021 /auto-binding-space 0 /exports RayTracingLightingMS /Zpr /O3 /enable-16bit-types -Wno-parentheses-equality /T lib_6_6 /Fc RayTracingLightingMS.d3dasm /Fo RayTracingLightingMS.dxil RayTracingLightingMS.usf
:END
PAUSE
