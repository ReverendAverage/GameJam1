...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E SingleLayerWaterCompositePS /Fc SingleLayerWaterComposite.d3dasm /Fo SingleLayerWaterComposite.dxil SingleLayerWaterComposite.usf
:END
PAUSE
