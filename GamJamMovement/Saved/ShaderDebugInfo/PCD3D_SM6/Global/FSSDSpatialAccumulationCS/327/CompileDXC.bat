...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc SSDSpatialAccumulation.d3dasm /Fo SSDSpatialAccumulation.dxil SSDSpatialAccumulation.usf
:END
PAUSE
