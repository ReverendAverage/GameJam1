...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E ShadowObjectCullVS /Fc DistanceFieldShadowing.d3dasm /Fo DistanceFieldShadowing.dxil DistanceFieldShadowing.usf
:END
PAUSE
