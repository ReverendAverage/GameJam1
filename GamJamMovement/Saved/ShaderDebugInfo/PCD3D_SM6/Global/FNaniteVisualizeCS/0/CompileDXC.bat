...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E VisualizeCS /Fc NaniteVisualize.d3dasm /Fo NaniteVisualize.dxil NaniteVisualize.usf
:END
PAUSE
