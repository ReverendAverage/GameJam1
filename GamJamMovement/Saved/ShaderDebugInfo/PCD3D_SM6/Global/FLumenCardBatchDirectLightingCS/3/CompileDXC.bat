...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E LumenCardBatchDirectLightingCS /Fc LumenSceneDirectLighting.d3dasm /Fo LumenSceneDirectLighting.dxil LumenSceneDirectLighting.usf
:END
PAUSE
