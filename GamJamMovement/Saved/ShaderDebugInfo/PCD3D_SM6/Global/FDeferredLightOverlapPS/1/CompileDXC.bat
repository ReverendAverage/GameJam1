...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E OverlapPixelMain /Fc StationaryLightOverlapShaders.d3dasm /Fo StationaryLightOverlapShaders.dxil StationaryLightOverlapShaders.usf
:END
PAUSE
