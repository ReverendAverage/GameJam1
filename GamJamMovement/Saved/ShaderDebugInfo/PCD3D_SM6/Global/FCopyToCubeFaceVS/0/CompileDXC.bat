...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E CopyToCubeFaceVS /Fc ReflectionEnvironmentShaders.d3dasm /Fo ReflectionEnvironmentShaders.dxil ReflectionEnvironmentShaders.usf
:END
PAUSE
