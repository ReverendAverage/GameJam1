...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ExportDebugViewPS /Fc NaniteDebugViews.d3dasm /Fo NaniteDebugViews.dxil NaniteDebugViews.usf
:END
PAUSE
