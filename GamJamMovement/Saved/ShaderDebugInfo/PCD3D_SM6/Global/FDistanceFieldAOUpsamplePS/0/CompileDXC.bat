...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E AOUpsamplePS /Fc DistanceFieldLightingPost.d3dasm /Fo DistanceFieldLightingPost.dxil DistanceFieldLightingPost.usf
:END
PAUSE
