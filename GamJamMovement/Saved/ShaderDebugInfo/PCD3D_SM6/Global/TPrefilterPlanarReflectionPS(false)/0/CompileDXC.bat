...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E PrefilterPlanarReflectionPS /Fc PlanarReflectionShaders.d3dasm /Fo PlanarReflectionShaders.dxil PlanarReflectionShaders.usf
:END
PAUSE
