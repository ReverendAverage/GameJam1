...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ObjectCullPS /Fc DistanceFieldObjectCulling.d3dasm /Fo DistanceFieldObjectCulling.dxil DistanceFieldObjectCulling.usf
:END
PAUSE
