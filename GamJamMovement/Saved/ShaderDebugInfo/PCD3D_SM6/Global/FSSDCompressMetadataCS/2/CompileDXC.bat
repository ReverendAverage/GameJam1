...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E MainCS /Fc SSDCompressMetadata.d3dasm /Fo SSDCompressMetadata.dxil SSDCompressMetadata.usf
:END
PAUSE
