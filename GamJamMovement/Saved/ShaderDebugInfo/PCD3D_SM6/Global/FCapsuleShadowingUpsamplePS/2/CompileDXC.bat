...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E CapsuleShadowingUpsamplePS /Fc CapsuleShadowShaders.d3dasm /Fo CapsuleShadowShaders.dxil CapsuleShadowShaders.usf
:END
PAUSE
