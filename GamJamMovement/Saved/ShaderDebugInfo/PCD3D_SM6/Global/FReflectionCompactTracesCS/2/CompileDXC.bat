...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ReflectionCompactTracesCS /Fc LumenReflectionTracing.d3dasm /Fo LumenReflectionTracing.dxil LumenReflectionTracing.usf
:END
PAUSE
