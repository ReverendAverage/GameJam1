...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E MainPS /Fc DiffuseIndirectComposite.d3dasm /Fo DiffuseIndirectComposite.dxil DiffuseIndirectComposite.usf
:END
PAUSE
