...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E ScreenProbeFilterGatherTracesCS /Fc LumenScreenProbeFiltering.d3dasm /Fo LumenScreenProbeFiltering.dxil LumenScreenProbeFiltering.usf
:END
PAUSE
