...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E DownsampleCS /Fc ReflectionEnvironmentShaders.d3dasm /Fo ReflectionEnvironmentShaders.dxil ReflectionEnvironmentShaders.usf
:END
PAUSE
