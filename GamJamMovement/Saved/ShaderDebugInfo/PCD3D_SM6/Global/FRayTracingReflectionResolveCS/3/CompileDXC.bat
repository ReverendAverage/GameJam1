...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T cs_6_6 /E RayTracingReflectionResolveCS /Fc RayTracingReflectionResolve.d3dasm /Fo RayTracingReflectionResolve.dxil RayTracingReflectionResolve.usf
:END
PAUSE
