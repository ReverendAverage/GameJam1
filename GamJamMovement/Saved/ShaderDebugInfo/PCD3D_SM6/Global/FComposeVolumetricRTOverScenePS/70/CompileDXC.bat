...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T ps_6_6 /E ComposeVolumetricRTOverScenePS /Fc VolumetricRenderTarget.d3dasm /Fo VolumetricRenderTarget.dxil VolumetricRenderTarget.usf
:END
PAUSE
