...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality /T vs_6_6 /E CapsuleShadowingUpsampleVS /Fc CapsuleShadowShaders.d3dasm /Fo CapsuleShadowShaders.dxil CapsuleShadowShaders.usf
:END
PAUSE
