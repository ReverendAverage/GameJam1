...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O1 -Wno-parentheses-equality /T cs_6_6 /E BuildTileConesMain /Fc DistanceFieldObjectCulling.d3dasm /Fo DistanceFieldObjectCulling.dxil DistanceFieldObjectCulling.usf
:END
PAUSE
